...
<div class="header-svg-container svg-visa position-10per-h1">
        <h1>You don't fly without a VISA</h1>
        <p>Meticulous planning and 20+ years of successful experience</p>
        <form action="https://www.yourcompany.co/Form%20Responses/shortresponseemail.php" method="POST" class="svg-visa-form">
    ...
    <div class="success-story-div-product-common-section-inner">
        <div class="success-story-div-product-common-section-inner-left">
            ...
            <p>"I appreciate how motivated the team kept me through the entire process and never let me doubt how the result of my outcomes would be which in the end was awesome."</p>
            <label class="text-align-right">Pranavi</label>
        </div>
        <div class="success-story-div-product-common-section-inner-right">
            <img src="../Photos/Testimonial Round Images/Pranavi MTS.png" />
        </div>
    </div>
</div>
    </section>
    ...
    <section class="product-common-section">
        ...
        <div class="programs-container">
            <div class="programs-container-inner">
                <div class="programs-container-inner-product-tile margin-left50-per">
                    ...
                    <form method="POST" action="../Payment/index.php?product=visa" class="free-product-common-form" id="essay-pkg-frm">
    ...
    <section class="product-common-section">
        ...
        <div class="product-common-faq-container">
            <div class="product-common-faq-inner">
                <h5>Are there dedicated experts to support students in VISA and Loan application?</h5>
                <p>Yes the mentor and a specialised visa consultant will individually support the students in the VISA application.</p>
                <h5>Will there be one on one guidance to understand the needs of my case?</h5>
                <p>Yes, the consultant will brief the student clearly on the his/her VISA requirements.</p>
                <h5>Will the expert guide and review prepared documents?</h5>
                <p>Yes after briefing on the requirements the visa consultant will share and support in documentation and compilation of necessary documents.</p>
                <h5>Will there be dedicated discussion to prepare for the Interview?</h5>
                <p>Yes, the consultant will hold one dedicated session to prepare the applicant for the VISA interview.</p>
            </div>
            <div class="product-common-faq-inner">
                <h5>What is the VISA approval rate for your students?</h5>
                <p>100% of yourcompany students receive VISA approvals due to diligent application process.</p>
                <h5>Can I apply for a visa alone without anyone's support?</h5>
                <p>Yes one can apply for the VISA process themselves however it is advisable to take expert advise because flying to your dream university without a VISA is not possible.</p>
                <h5>How long doe sit take to get the VISA?</h5>
                <p>It is highly subjective on the country you are applying to and many other factors too. The consultant will brief you individually on this particular aspect after reviewing your file.</p>
            </div>
        </div>
    </section>
