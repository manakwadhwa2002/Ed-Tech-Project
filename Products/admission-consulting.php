...
<head>
    ...
    <div class="header-svg-container svg-admission-consulting">
        ...
        <form action="https://www.yourcompany.co/Form%20Responses/shortresponseemail.php" method="POST" class="header-svg-cv-writing-form">
        ...
        <div class="success-story-div-product-common-section">
            <div class="success-story-div-product-common-section-inner">
                <div class="success-story-div-product-common-section-inner-left">
                    ...
                    <p>"Dilligent understanding of my career aspirations helped me get into Universities in Canada and Europe. yourcompany has a highly personalised process right and would recommend it to anyone in doubt."</p>
        ...
        <div class="programs-container">
            <div class="programs-container-inner admission-consulting-extra-class">
                <div class="programs-container-inner-product-tile">
                    ...
                    <form method="POST" action="../Payment/index.php?product=admsn_post_grad" class="free-product-common-form" id="adms-whsm-pkg-frm">
                ...
                <div class="programs-container-inner-product-tile">
                    ...
                    <form method="POST" action="../Payment/index.php?product=ess_sop_under_grad" class="free-product-common-form" id="essay-pkg-frm">
                        <input type="email" placeholder="Enter Your Email" name="purchase-order-email" />
                        <button type="submit">Buy Now</button>
                    </form>
                </div>
    ...
    <section class="product-common-section">
        ...
        <div class="product-common-faq-container">
            ...
            <div class="product-common-faq-inner">
                ...
                <p>Yes, yourcompany has one of the largest repository of scholarships with over 15000+ scholarships from across the world to support students.</p>
            </div>
        </div>
    </section>
